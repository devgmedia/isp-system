...
class ModifyApInvoiceItemPoCategoryTableP5 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('ap_invoice_item_po_category', function (Blueprint $table) {
            $table->dropUnique('ap_inv_ite_po_cat_name_unique');
        });

        Schema::table('ap_invoice_item_po_category', function (Blueprint $table) {
            $table->dropForeign('ap_invoice_item_po_category_chart_of_account_id_foreign');
            $table->dropForeign('ap_invoice_item_po_category_chart_of_account_card_id_foreign');
        });
