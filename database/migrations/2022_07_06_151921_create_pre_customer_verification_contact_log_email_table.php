...
class CreatePreCustomerVerificationContactLogEmailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pre_customer_verification_contact_log_email', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('pre_customer_email_id')->nullable()->default(null);
            ...
            $table->foreign(
                ...
                'pre_cus_pho_num_pre_cus_ema'
            )
                ->references('id')
                ->on('pre_customer_email')
                ->onDelete('set null');
        });
    }
    ...
    {
        Schema::drop('pre_customer_verification_contact_log_email');
    }
}
