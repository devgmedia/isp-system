...
class CreateArInvoiceWhatsappReceiptTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ar_invoice_whatsapp_receipt', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ar_invoice_whatsapp_receipt');
    }
}
