...
class UpdateArInvoiceCustomerProductAdditionalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ar_invoice_customer_product_additional', function (Blueprint $table) {
            ...
            $table->foreign(
                ...
                ->references('id')
                ->on('ar_invoice_scheme_customer_product_additional')
                ->onDelete('set null');
            ...
            $table->foreign(
                ...
                'ar_inv_cus_pro_add_cus_pro_add_id_foreign',
            )
                ->references('id')
    ...
    {
        Schema::dropIfExists('ar_invoice_customer_product_additional');
    }
}
