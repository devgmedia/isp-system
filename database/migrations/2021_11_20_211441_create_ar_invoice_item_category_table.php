...
class CreateArInvoiceItemCategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ar_invoice_item_category', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ar_invoice_item_category');
    }
}
